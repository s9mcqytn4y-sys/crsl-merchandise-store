                    ...
                    <div className="bg-white rounded-3xl max-w-md w-full p-8 shadow-2xl border border-slate-100 transform animate-in zoom-in-95 duration-200 space-y-6">
                        <div className="space-y-2">
                            ...
                            <p className="text-xs text-slate-600 leading-relaxed">
                                Apakah Anda yakin ingin menghapus akun Anda secara permanen? Seluruh riwayat transaksi dan poin keanggotaan akan hilang.
                            </p>
                        </div>
                        ...
                        <div className="flex items-center justify-end gap-3 pt-2">
                            ...
                            <button
                                ...
                                disabled={isDeleting}
                                className="px-6 py-2.5 bg-red-600 hover:bg-red-700 active:scale-95 text-white text-sm font-bold rounded-full shadow-md transition-all cursor-pointer disabled:opacity-50"
                            >
