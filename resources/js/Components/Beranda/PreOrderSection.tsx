            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12 items-center">
                    ...
                    <div className="md:col-span-7 flex flex-col gap-4 text-left">
                        <div className="inline-flex items-center gap-2 self-start px-3 py-1 bg-red-50 text-primary rounded-full text-xs font-bold tracking-wider uppercase">
                        ...
                        <div className="pt-2">
                            <a
                                href="/katalog"
                                className="inline-flex items-center gap-2 text-xs font-bold text-primary hover:text-primary-hover transition-colors group"
                            >
